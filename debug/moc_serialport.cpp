...
QT_MOC_LITERAL(1, 11, 11), // "recv_signal"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 7) // "content"

    },
    "SerialPort\0recv_signal\0\0content"
};
...
void SerialPort::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->recv_signal((*reinterpret_cast< const QByteArray(*)>(_a[1]))); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SerialPort::recv_signal)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject SerialPort::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_SerialPort.data,
...
// SIGNAL 0
void SerialPort::recv_signal(const QByteArray & _t1)
{
