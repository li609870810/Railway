...
QT_MOC_LITERAL(1, 11, 15), // "signal_SqlQuery"
QT_MOC_LITERAL(2, 27, 0), // ""
QT_MOC_LITERAL(3, 28, 4), // "data"
QT_MOC_LITERAL(4, 33, 19), // "signal_400mAnalysis"
QT_MOC_LITERAL(5, 53, 19), // "signal_GMSRAnalysis"
...
void MainWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->signal_SqlQuery((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        case 1: _t->signal_400mAnalysis((*reinterpret_cast< const QByteArray(*)>(_a[1]))); break;
        case 2: _t->signal_GMSRAnalysis((*reinterpret_cast< const QByteArray(*)>(_a[1]))); break;
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MainWindow::signal_SqlQuery)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MainWindow::signal_400mAnalysis)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (MainWindow::*_t)(const QByteArray & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MainWindow::signal_GMSRAnalysis)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 0
void MainWindow::signal_SqlQuery(const QString & _t1)
{
...
// SIGNAL 1
void MainWindow::signal_400mAnalysis(const QByteArray & _t1)
{
    void *_a[] = { Q_NULLPTR, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
...
// SIGNAL 2
void MainWindow::signal_GMSRAnalysis(const QByteArray & _t1)
{
    void *_a[] = { Q_NULLPTR, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
