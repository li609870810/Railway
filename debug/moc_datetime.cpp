...
QT_MOC_LITERAL(1, 9, 10), // "selectTime"
QT_MOC_LITERAL(2, 20, 0), // ""
QT_MOC_LITERAL(3, 21, 3), // "str"
QT_MOC_LITERAL(4, 25, 21) // "on_pushButton_clicked"

    },
    "DateTime\0selectTime\0\0str\0on_pushButton_clicked"
};
...
void DateTime::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->selectTime((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        ...
        {
            typedef void (DateTime::*_t)(const QString & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&DateTime::selectTime)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject DateTime::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_DateTime.data,
      qt_meta_data_DateTime,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
// SIGNAL 0
void DateTime::selectTime(const QString & _t1)
{
